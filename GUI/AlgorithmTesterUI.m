...
algoDD = uidropdown(panel, ...
    'Items', {'AStar', 'AStar_v0', 'AStar_v1', 'AStar_v1_1', 'AStar_v1_2', 'AStar_v2', 'AStar_v3', 'AStar_v4', 'Dijkstra', 'Dijkstra_v1', 'RRT'}, ...
    'Value', 'AStar', ...
...
% ================================================================
    ...
    function runAlgorithm()
        ...
        switch algoName
            ...
            case 'AStar_v0'
                AStar_v0(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v1'
                AStar_v1(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v1_1'
                AStar_v1_1(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v1_2'
                AStar_v1_2(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v2'
                AStar_v2(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v3'
                AStar_v3(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'AStar_v4'
                AStar_v4(m, mapData.startGrid, mapData.goalGrid, 0, @algoCallback);
            case 'Dijkstra'
